...
class TvDatafeedLive(tvDatafeed.TvDatafeed):
    ...
    def get_hist(self,  
        ...
        adjustment : str, optional
            price adjustment mode. "dividends" for splits+dividends adjusted
            (default), "splits" for splits only, "" for no adjustment.
        ...
        if self._lock.acquire(timeout=timeout) is False:
            return False
        data=super().get_hist(symbol, exchange, interval, n_bars, fut_contract, extended_session, adjustment)
        self._lock.release()
